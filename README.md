# Kids Journey Hub - Developer Documentation
...
Kids Journey Hub is a full-stack e-commerce platform built with Next.js 15. It includes a customer-facing storefront and a password-protected admin dashboard.
...
```bash
git clone https://github.com/yourusername/kidsjourneyhub.git
cd kidsjourneyhub
```
...
```json
{
  ...
  "public_id": "kidsjourneyhub/products/abc123"
}
```
...
Images are stored on Cloudinary under the folder `kidsjourneyhub/products`.
...
2. Add your domain (e.g., `kidsjourneyhub.com`)
...
```bash
git clone https://github.com/yourusername/kidsjourneyhub.git new-client-store
cd new-client-store
```
...
### Platform: Kids Journey Hub v1.0
