...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link href={`/products/${product.slug}`}>
      <Card className="group shadow-none overflow-hidden rounded-lg py-0 gap-2 h-94">
        ...
        <CardContent className="px-4">
          <h3 className="font-semibold text-lg mb-2 line-clamp-2 bg-linear-to-r from-[#FF8C00] via-[#FFD700] to-[#00AEEF] text-transparent bg-clip-text transition-colors">
            {product.name}
          </h3>
